...
const requestTravelService = require('../../../src/services/passengerservice');

describe('Verificando service pessoa passageira', function () {
    describe('requisitando viagem', function () {
        it('sem pontos de parada é realizada com sucesso', async function () {
            ...
            // act
            const travel = await requestTravelService.requestTravel(
                passenger.id,
        ...
        it('com mesmo local de origem e destino é rejeitada', async function () {
            ...
            // act
            const error = await requestTravelService.requestTravel(
                passenger.id,
                passenger.startingAddress,
                passenger.endingAddress,
            );
